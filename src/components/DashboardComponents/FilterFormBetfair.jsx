...
export function FilterFormBetfair({ fields, setFields }) {
    return (
        <div className="flex flex-col justify-center gap-4 shadow-lg">
            <div className="flex flex-col gap-4 md:flex-row">
                    ...
                    <div className="flex flex-1 items-center justify-between h-24 bg-slate-700 rounded-md p-2 shadow-lg shadow-slate-900 hover:shadow-indigo-500/40">
                        <FormGroup>
                            <p className="text-white text-lg font-medium">Serie A</p>
                            <FormControlLabel
                                control={
                                    <Switch
                                        color="info"
                                        checked={fields.liga === 'seriea'}
                                        onChange={() => setFields({ ...fields, liga: 'seriea' })}
                                    />
                                }
                            />
                        </FormGroup>
                        <img src={seriea} alt="Serie A" className="w-24 h-20" />
                    </div>

                    <div className="flex flex-1 items-center justify-between h-24 bg-slate-700 rounded-md p-2 shadow-lg shadow-slate-900 hover:shadow-indigo-500/40">
                        <FormGroup>
                            <p className="text-white text-lg font-medium">Champions</p>
                            <FormControlLabel
                                control={
                                    <Switch
                                        color="info"
                                        checked={fields.liga === 'champions'}
                                        onChange={() => setFields({ ...fields, liga: 'champions' })}
                                    />
                                }
                            />
                        </FormGroup>
                        <img src={champions} alt="Copa Do Mundo" className="w-20 h-20" />
                    </div>  
