        ...
        <TableRow style={{ width: 'full' }}>
          ...
          {data &&
            data
              ...
              .map(row => {
                return row.result_ht_correct_score_casa ===
                  row.result_ht_correct_score_visitante ? (
                  row.result_ht_correct_score_casa === 'Oth' ? (
                    <BootstrapTooltip
                      ...
                      placement="top-start"
                    >
                      <StyledTableCellYellow align="center" key={row.id_jogo}>
                        Oth
                    ...
                    >
                      <StyledTableCellGreen align="center">
                        {row.result_ht_correct_score_casa +
                          'x' +
                          row.result_ht_correct_score_visitante}
