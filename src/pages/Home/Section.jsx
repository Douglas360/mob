        ...
        <>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="place-self-center mr-auto lg:col-span-7">
                        ...
                        <img src='https://supertips.com.br/static/media/Bet365_Logo.cb7a4dcd22efce88b9ab.png' alt='' className='m-1 mb-2' />
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src='https://supertips.com.br/static/media/mockup.63417b662498d8cca52c.png' alt="mockup" />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-white dark:bg-gray-900">
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                    ...
                    <img className="mt-4 w-full rounded-lg lg:mt-10" src='https://supertips.com.br/static/media/jogado.8d7d44c673d93d315b09.jpg' alt="office content 2" />
                </div>
            </section>
